...
#step 0: remove emotion
#step 1: convert englsih word
#step 2: group together name entity such as phone name, url, . . .
#step 3: expanding abbi word
#step 4: tokinization

def remove_emotion(str):
    """
...
def convert_english_word(str):
    letter = re.sub("(\sthank\s)|(^thank\s)", " anh ".encode('utf-8'), str)
def conver_abbr(str):
